...
function drawEditor(showGuides=true){
  ...
  if(state.image){
    ...
    ctx.fillStyle='#a7a7a2'; ctx.textAlign='center'; ctx.font='600 28px Manrope, Arial'; ctx.fillText('Загрузите изображение',canvas.width/2,canvas.height/2-5);
    ctx.fillStyle='#c0c0bb'; ctx.font='400 18px Manrope, Arial'; ctx.fillText('и расположите его в области печати',canvas.width/2,canvas.height/2+31);
  }
